...
@Component({
  selector: 'app-mantenimiento-arco',
  templateUrl: './mantenimiento-arco.component.html',
  styleUrls: ['./mantenimiento-arco.component.css']
})
export class MantenimientoArcoComponent {
  ...
  async ngOnInit(): Promise<void> {
    this.idArco = sessionStorage.getItem('arcoId');
    this.cargado = true;
  }
  ...
  async enviar() {
    ...
    try {
      await this.firebaseService.addToArrayInDocument("Arcos", this.idArco, "mantenimiento", newObj);
